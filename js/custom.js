...
function writeSocialShareLinks(region) {
    ...
    if (region === 'footer') {
        ...
        return '<span>Stay connected on : </span>' +
            ...
            '<a href="'+linkedin_social+'" target="_blank"  data-toggle="tooltip" data-placement="bottom" title="Linkedin"><i class="fa fa-linkedin"></i></a>' +
            // '<a href="'+quora_social+'" target="_blank"  data-toggle="tooltip" data-placement="bottom" title="Quora"><i class="fa fa-quora"></i></a>';
            '<a href="'+pinterest_social+'" target="_blank"  data-toggle="tooltip" data-placement="bottom" title="Pinterest"><i class="fa fa-pinterest-p"></i></a>' +
