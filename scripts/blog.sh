...
<meta name="google-site-verification" content="oIpwGHdguWnER2N8lKSljpYFSSUvg8A-sFzQkn-xLnU" />
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-78CFE4WNGX"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag("js", new Date());
        gtag("config", "G-78CFE4WNGX");
    </script>
    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
                ...
                <a class="navbar-brand" href="/"><img alt="Peoples Blog" src="../../../upload/logo_new.png"></a>
                ...
                <div class="col-lg-7">
                    <div class="widget">
                        <div class="footer-text text-left">
                            <a href="/"><img alt="Peoples Blog" src="../../../upload/logo_new.png" class="img-fluid"></a>
