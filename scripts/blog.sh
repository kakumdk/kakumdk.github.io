    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
                ...
                <a class="navbar-brand" href="/index.html"><img alt="Peoples Blog" src="../../../upload/logo_new.png"></a>
                ...
                <div class="col-lg-7">
                    <div class="widget">
                        <div class="footer-text text-left">
                            <a href="/index.html"><img alt="Peoples Blog" src="../../../upload/logo_new.png" class="img-fluid"></a>
