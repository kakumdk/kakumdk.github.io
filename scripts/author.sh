...
pwd=$(pwd)
authorscontent=$pwd/authors-content
authors=$pwd/authors

## Blogs index page
authorsfolderpath=$authors
mkdir -p $authorsfolderpath
authorsfilepath=$authorsfolderpath'/'index.html
echo '<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Basic -->
    ...
    <!-- Site Metas -->
    <title>Authors - Peoples Blog</title>
    <meta name="description" content="Authors - Peoples Blog articles, came out of Thoughts, Ideas & Experiences. Articles about Lifestyle, Travel, Food, Science & Technology">
    ...
    <meta property="og:title" content="Authors - Peoples Blog" />
    <meta property="og:description" content="Authors - Peoples Blog articles, came out of Thoughts, Ideas & Experiences. Articles about Lifestyle, Travel, Food, Science & Technology" />
    <meta property="og:url" content="https://peoplesblog.co.in/authors/index.html" />
    <meta property="og:image" content="https://peoplesblog.co.in/upload/logo_new.webp" />
    <meta name="twitter:title" content="Links - Peoples Blog">
    <meta name="twitter:description" content="Authors - Peoples Blog articles, came out of Thoughts, Ideas & Experiences. Articles about Lifestyle, Travel, Food, Science & Technology">
...
files=`ls $authorscontent`
for file in $files
do
  filepath=$authorscontent'/'$file
  author=`jq -r '.content .author' $filepath`
  banner400x400=`jq -r '.content .banner400x400' $filepath`
  intro=`jq -r '.content .intro' $filepath`
  linkedin=`jq -r '.content .linkedin' $filepath`
  twitter=`jq -r '.content .twitter' $filepath`
  facebook=`jq -r '.content .facebook' $filepath`
  instagram=`jq -r '.content .instagram' $filepath`
  youtube=`jq -r '.content .youtube' $filepath`
  website=`jq -r '.content .website' $filepath`
  file=`jq -r '.content .file' $filepath`

    ## Authors
    authorspath=$authorsfolderpath'/'$file
    authorsfilepath=${authorspath/%.json}.html
    echo '<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Basic -->
    ...
    <!-- Site Metas -->
    <title>'$author' - Peoples Blog - Lifestyle, Travel, Food, Science & Technology</title>
    ...
    <meta name="author" content="'$author' - Peoples Blogs">
                    ...
                    <div class="page-wrapper">
                        <div class="custombox authorbox clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-center author-image-wrapper">
